...
public:
  SC_PROPERTY(Keynode("question_find_linegraph"), ForceCreate)
  static ScAddr question_find_linegraph;

  SC_PROPERTY(Keynode("nrel_linegraph"), ForceCreate)
  static ScAddr nrel_linegraph;
