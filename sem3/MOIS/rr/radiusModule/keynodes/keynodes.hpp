...
public:
  SC_PROPERTY(Keynode("question_find_radius"), ForceCreate)
  static ScAddr question_find_radius;

  SC_PROPERTY(Keynode("nrel_search_result"), ForceCreate)
  static ScAddr nrel_search_result;

  SC_PROPERTY(Keynode("nrel_radius_of_graph"), ForceCreate)
  static ScAddr nrel_radius_of_graph;
